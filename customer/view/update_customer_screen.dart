...
class _UpdateCustomerScreenState extends State<UpdateCustomerScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      controller.loadCustomerUpdateData(widget.id);
    });
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBar(title: LocalStrings.updateCustomer.tr),
                  ...
                  views: [
                    Padding(
                      ...
                      child: RefreshIndicator(
                        ...
                        onRefresh: () async {
                          await controller.loadCustomerUpdateData(widget.id);
                        },
                        child: SingleChildScrollView(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              FutureBuilder(
                                future: customerGroupsMemoizer.runOnce(
                                  controller.loadCustomerGroups,
                                ),
                                    ...
                                    return CustomMultiDropDownTextField(
                                      ...
                                      onChanged: (options) {
                                        ...
                                        for (var v in options) {
                                          controller.groupsList.add(
                                            v.toString(),
                                          );
                                        }
                                      },
                                      items: controller.groupsModel.data!.map((
                                        value,
                                      ) {
                                        return DropdownItem(
                                          label: value.name?.tr ?? '',
                              ...
                              FutureBuilder(
                                future: countriesMemoizer.runOnce(
                                ...
                                builder: (context, countriesList) {
                                  if (countriesList.data?.status ?? false) {
                                    ...
                                    return CustomDropDownWithTextField(
                                      selectedValue:
                                          LocalStrings.noCountryFound.tr,
                            ...
                            children: [
                              ...
                              FutureBuilder(
                                ...
                                builder: (context, data) {
                                  return CustomDropDownTextField(
                                    hintText:
                                        LocalStrings.selectBillingCountry.tr,
                                    onChanged: (value) {
