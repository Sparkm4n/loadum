class ExpenseDetailsModel {
  ExpenseDetailsModel({bool? status, String? message, ExpenseDetails? data}) {
    _status = status;
    _message = message;
    _data = data;
  }
  ...
  ExpenseDetailsModel.fromJson(dynamic json) {
    ...
    _data = json['data'] != null ? ExpenseDetails.fromJson(json['data']) : null;
  }

  bool? _status;
  String? _message;
  ExpenseDetails? _data;

  bool? get status => _status;
  String? get message => _message;
  ExpenseDetails? get data => _data;
...
class ExpenseDetails {
  ...
  ExpenseDetails.fromJson(dynamic json) {
    _id = json['id'];
    ...
    _currencyData = json['currency_data'] != null
        ? Currency.fromJson(json['currency_data'])
        : null;
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (_currencyData != null) {
      map['currency_data'] = _currencyData?.toJson();
    }
    return map;
  }
}
