...
class InvoiceDetailsModel {
  InvoiceDetailsModel({bool? status, String? message, InvoiceDetails? data}) {
    _status = status;
    _message = message;
    _data = data;
  }
  ...
  InvoiceDetailsModel.fromJson(dynamic json) {
    ...
    _data = json['data'] != null ? InvoiceDetails.fromJson(json['data']) : null;
  }

  bool? _status;
  String? _message;
  InvoiceDetails? _data;

  bool? get status => _status;
  String? get message => _message;
  InvoiceDetails? get data => _data;
...
class InvoiceDetails {
  InvoiceDetails({
    ...
    List<dynamic>? allowedPaymentModes,
    String? token,
  ...
  List<dynamic>? _allowedPaymentModes;
  String? _token;
  ...
  List<dynamic>? get allowedPaymentModes => _allowedPaymentModes;
...
class ProjectData {
  ProjectData({String? id, String? name, String? description, String? status}) {
    _id = id;
    _name = name;
