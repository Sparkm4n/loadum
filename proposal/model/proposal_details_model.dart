...
class ProposalDetailsModel {
  ProposalDetailsModel({bool? status, String? message, ProposalDetails? data}) {
    _status = status;
    _message = message;
    _data = data;
  }
  ...
  bool? _status;
  String? _message;
  ProposalDetails? _data;

  bool? get status => _status;
  String? get message => _message;
  ProposalDetails? get data => _data;
...
class ProposalDetails {
  ...
  ProposalDetails.fromJson(dynamic json) {
    _id = json['id'];
